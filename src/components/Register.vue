        ...
        <el-row>
          <el-form  :model="registerForm" status-icon :rules="rules" size="medium" ref="registerForm" label-width="100px" class="demo-registeForm">
            ...
            <el-form-item label="性别" prop="sex">
              <el-radio @keyup.enter.native="Register('registerForm')" v-model="registerForm.sex" label="男">男</el-radio>
              <el-radio @keyup.enter.native="Register('registerForm')" v-model="registerForm.sex" label="女">女</el-radio>
            </el-form-item>
           
            <el-form-item label="电话" prop="tel">
              <el-input @keyup.enter.native="Register('registerForm')" v-model="registerForm.tel" autocomplete="off" placeholder="请输入电话" type="number">
              </el-input>
            </el-form-item>
    ...
    methods: {
      ...
      Register(formName) {
        ...
        // 表单验证通过，可进行操作
            ...
            console.log(this.registerForm.checkPass)
